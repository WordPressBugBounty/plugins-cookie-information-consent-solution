...
2. Search for **Cookie Information**.
3. Click **Install now**.
4. Click **Activate**.

= From WordPress.org =

1. Download **Cookie Information** plugin.
2. Unzip and upload the **Cookie Information** plugin to your `/wp-content/plugins/` directory using ftp, sftp, scp or other method.
